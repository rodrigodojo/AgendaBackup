...
public class ContatoDAO extends SQLiteOpenHelper {
    ...
    private static final String TABELA = "Contados";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String ddl = "CREATE TABLE " + TABELA + "(id INTEGER PRIMARY KEY,"+"nome TEXT NOT NULL,"
                +"email TEXT,"+"endereco TEXT,"+"site TEXT,"+"telefone TEXT,"+"caminhoFoto TEXT);";
